...
from cfg.config import load_cfg_and_update_args
...
if __name__ == '__main__':
    ...
    ## need to change the path to the configuration file
    args.cfg = r'F:\YOON\research\detr_pose_jaxa\cfg\config_desktop.yaml'
    

    if args.cfg:
        args = load_cfg_and_update_args(args)
        print('cfg loaded')
        print(f'cofiguration file from {args.cfg}')
    ...
    with open(os.path.join(args.output_dir, 'train_info.txt'), 'w') as f:
        for key, value in vars(args).items():
            f.write(f'{key}: {value}\n')
        print('train_info.txt saved')    
